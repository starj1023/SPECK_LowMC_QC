...
def Enc(eng):
    ...
    if (resource_check != 1):
        ...
        Round_constant_XOR(eng, l2, 0x1b1a1918, 32)

        Round_constant_XOR(eng, y, 0x7475432d, 32)
        Round_constant_XOR(eng, x, 0x3b726574, 32)
    ...
    for i in range(8):
        ...
        improved_adder(eng, k0, l2, c1, 31)
...
def new_adder(eng, a, b, len):
    ...
    for i in range(len - 1):
        ...
        Toffoli_gate(eng, b[len - 2 - i], a[len - 2 - i], a[len - 1 - i])
